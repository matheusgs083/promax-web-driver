...
from pages.rotinas.relatorio_140510_page import Relatorio140510Page
...
# Rotina no menu (geralmente é o CALL “14.05.10.00.00”)
...
def main():
    ...
    try:
        ...
        try:
            ...
            arquivos_excel = [f for f in glob.glob(os.path.join(pasta_data, "*.xlsx"))
